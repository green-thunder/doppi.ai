        ...
        <ul className="mt-12 grid grid-cols-1 gap-4 lg:grid-cols-2">
          {t.problem.items.map((item, i) => (
            <Reveal
              ...
              as="li"
              delayIndex={i}
              className="group flex items-start gap-4 rounded-2xl border border-border bg-card/40 p-5 transition-all duration-300 hover:-translate-y-0.5 hover:border-foreground/25 hover:shadow-card motion-reduce:hover:translate-y-0"
            >
